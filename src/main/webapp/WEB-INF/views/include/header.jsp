...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="/super">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/change">HOME</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">공지사항</a> <!-- list.notice -->
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">게시판</a> <!-- list.board?currentPage=1 -->
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#">사진게시판</a> <!-- list.thumbnail -->
          </li>
